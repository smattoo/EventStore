...
//                throw new ArgumentException("lastCheckpointPosition cannot be equal to zero position");
            ...
            var newPhysicalStream = message.Result == ReadStreamResult.NoStream;
            ...
            if (_lastCommittedOrSubmittedEventPosition == null)
            {
                ...
                _lastKnownEventNumber = newPhysicalStream ? ExpectedVersion.NoStream : _retrievedNextEventNumber - 1;
